...
exports.getAllForPageBuilder =
  exports.filterUtils =
  exports.getNavbarUtils =
  exports.getAllCatWithSubCat =
  exports.singleCategoryForCategoryEditPage =
  exports.getAllCategoriesForCatMainPage =
  exports.allCategoryForFiltering =
  exports.allCategoriesForAdminCatIndexPage =
  exports.productAddUtils =
  exports.allCategoriesForSubCatAddPage =
  exports.update =
...
const subcategory_model_1 = __importDefault(
  require("../subcategory/subcategory.model")
);
const user_model_1 = __importDefault(require("../user/user.model"));
const suggestion_model_1 = __importDefault(
  require("../suggestion/suggestion.model")
);
const create = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const item = yield category_model_1.default.create(
        Object.assign(Object.assign({}, req.body), {
          slug: (0, generateSLug_1.generateSlug)(req.body.title),
        })
      );
...
const singleForEditPage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const item = yield category_model_1.default.findOne({
        _id: req.params.id,
      });
...
const update = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params;
      const updatedItem = yield category_model_1.default.findByIdAndUpdate(
        id,
        req.body,
        {
...
// Get all
const allCategoriesForSubCatAddPage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
    ...
    try {
      ...
      const [categories, subcategories, sellers, writers, suggestions] =
        yield Promise.all([
          ...
          user_model_1.default
            ...
            .sort({ createdAt: -1 })
            .select("name image"),
          writer_model_1.default
            .find()
            .select("title img")
            .sort({ createdAt: -1 }),
          suggestion_model_1.default
            .find()
            .select("title")
            .sort({ createdAt: -1 }),
        ]);
      ...
      const categoriesWithSubs = categories.map((category) => {
        const subs = subcategories.filter((sub) => {
          var _a;
          return (
            ((_a = sub.parentCategory) === null || _a === void 0
              ? void 0
              : _a.toString()) === category._id.toString()
          );
        });
...
// Get all
const allCategoriesForAdminCatIndexPage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const items = yield category_model_1.default
        .find()
...
// Get all
const allCategoryForFiltering = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// Get all
const getAllCategoriesForCatMainPage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// Get single
const singleCategoryForCategoryEditPage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const item = yield category_model_1.default.findOne({
        _id: req.params.id,
...
const getAllCatWithSubCat = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const [categories, writers, publishers] = yield Promise.all([
        ...
        user_model_1.default
          .find({ isEnabledByAdmin: true, role: "seller" })
...
// ✅ GET all categories for filter page
const filterUtils = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const [categories, subcategories, sellers, writers] = yield Promise.all([
        category_model_1.default
          .find({}, { _id: 1, slug: 1, title: 1, img: 1 })
          .sort({
            position: 1,
          }),
        subcategory_model_1.default
          .find({}, { _id: 1, slug: 1, title: 1, img: 1, parentCategory: 1 })
          .sort({
            position: 1,
          }),
        user_model_1.default
...
const getAllForPageBuilder = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const items = yield category_model_1.default
        .find()
