...
const model_1 = require("../../affiliateClick/model");
...
const calculateAffiliateCommission = (productId, affiliateCode, orderAmount, orderId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield model_1.AffiliateClick.updateOne({ affiliate: user._id, product: productId, converted: false }, { converted: true, order: orderId });
