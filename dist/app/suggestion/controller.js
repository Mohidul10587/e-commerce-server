...
const getAllSuggestions = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const suggestions = yield model_1.default.find().populate({
            path: "products",
...
const getSuggestionById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const suggestion = yield model_1.default.findById(id).populate({
            path: "products",
...
const deleteSuggestion = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const deletedSuggestion = yield model_1.default.findByIdAndDelete(id);
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const updatedItem = yield model_1.default.findByIdAndUpdate(id, req.body, {
