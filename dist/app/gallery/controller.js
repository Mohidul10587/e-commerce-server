...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const obj = req.body;
        const result = yield model_1.default.create(obj);
...
const getOne = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield model_1.default.findById(req.params.id);
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield model_1.default.findByIdAndUpdate(req.params.id, req.body, {
            new: true,
        });
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield model_1.default.findByIdAndDelete(req.params.id);
