...
exports.orderRoutes.patch("/:id/payment", auth_1.verifyAdminManagerOrSupport, order_controller_1.updateOrderPayment);
exports.orderRoutes.get("/:id/payments", order_controller_1.getOrderPayments);
exports.orderRoutes.patch("/:id/payments/:txId", auth_1.verifyAdminManagerOrSupport, order_controller_1.updateOrderPaymentTx);
exports.orderRoutes.delete("/:id/payments/:txId", auth_1.verifyAdminManagerOrSupport, order_controller_1.deleteOrderPayment);
exports.orderRoutes.patch("/:id/discount", auth_1.verifyAdminManagerOrSupport, order_controller_1.updateOrderDiscount);
exports.orderRoutes.post("/:id/items", auth_1.verifyAdminManagerOrSupport, order_controller_1.addOrderItem);
exports.orderRoutes.put("/:id", auth_1.verifyAdminManagerOrSupport, order_controller_1.updateOrder);
exports.orderRoutes.patch("/:id/restore", auth_1.verifyAdminManagerOrSupport, order_controller_1.restoreOrder);
