        ...
        try {
            ...
            const product = yield prisma_1.default.$transaction((tx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const created = yield tx.product.create({
                    data: Object.assign(Object.assign({}, productData), { keywords: (_a = productData.keywords) !== null && _a !== void 0 ? _a : [], totalStock: 0, variants: {
                            create: variants.map((_a) => {
...
function deleteProduct(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const id = parseInt(req.params.id);
            yield prisma_1.default.product.update({ where: { id }, data: { isActive: false } });
