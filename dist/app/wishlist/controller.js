...
const addToWishlist = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        let wishlist = yield model_1.default.findOne({ userId });
        // If no wishlist exists for the user, create a new one
        if (!wishlist) {
            wishlist = yield model_1.default.create({
                userId,
...
const deleteSingleFromWishlist = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const wishlist = yield model_1.default.findOne({ userId });
        if (!wishlist) {
            return res
                .status(404)
...
const getWishlist = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const wishlist = yield model_1.default.findOne({ userId }).populate("items.product");
        if (!wishlist) {
...
const clearWishlist = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const wishlist = yield model_1.default.findOneAndUpdate({ userId }, { items: [] }, { new: true });
        if (!wishlist) {
            return res
                .status(404)
                .json({ success: false, message: "Wishlist not found" });
