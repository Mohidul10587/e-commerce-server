...
router.get(
  ...
  subcategory_controller_1.singleForEditPage
);
router.get(
  "/allSubcategoriesForAdminSubCatIndexPage",
  subcategory_controller_1.allSubcategoriesForAdminSubCatIndexPage
);
router.put("/update/:id", subcategory_controller_1.update);
router.delete(
  "/delete/:id",
  middlewares_1.verifyAdmin,
  (0, reusableControllers_1.deleteById)(subcategory_model_1.default)
);
