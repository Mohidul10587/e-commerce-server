...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const newCategory = yield writer_model_1.default.create(Object.assign(Object.assign({}, req.body), { slug: (0, generateSLug_1.generateSlug)(req.body.title), createdBy: (_a = req.user) === null || _a === void 0 ? void 0 : _a._id }));
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const existingWriter = yield writer_model_1.default.findById(id);
        if (!existingWriter) {
