...
const model_1 = __importDefault(require("./model")); // Ensure the correct path to the model
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const item = yield model_1.default.create(req.body);
...
const getAllBanners = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const banners = (yield model_1.default.find()).reverse();
...
const getBannerById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const banner = yield model_1.default.findById(req.params.id);
        if (!banner) {
...
const deleteBannerById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const banner = yield model_1.default.findByIdAndDelete(bannerId);
        if (!banner) {
            return res.status(404).json({ error: "Banner not found" });
        }
...
const getBannersByCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const banners = yield model_1.default.find({ category: categoryId });
        res.status(200).json(banners);
    }
    catch (error) {
        console.error("Error:", error);
...
const getBannersByBrand = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Find banners that contain the specified category ID
        const banners = yield model_1.default.find({ brands: brandId });
        res.status(200).json(banners);
    }
    catch (error) {
        console.error("Error:", error);
...
const updatePagesInBanners = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield model_1.default.updateMany({}, { pages: newPages });
        // Optionally, fetch updated banners after update
        const updatedBanners = yield model_1.default.find();
...
const getBannersWithHomePageChecked = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const banners = yield model_1.default.find({
            "pages.title": "Home",
            "pages.checked": true,
