...
router.post("/create", middlewares_1.verifyAdmin, banner_controller_1.create);
router.get(
  "/singleForEditPage/:id",
  middlewares_1.verifyAdmin,
  banner_controller_1.singleForEditPage
);
router.put(
  "/update/:id",
  middlewares_1.verifyAdmin,
  banner_controller_1.update
);
...
router.delete(
  "/delete/:id",
  middlewares_1.verifyAdmin,
  (0, reusableControllers_1.deleteById)(banner_model_1.default)
);
